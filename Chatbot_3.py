...
class DocChatBot:
    def __init__(self, file_paths):  # ✅ fixed __init_
    ...
    def chat(self):
        print("Welcome to the ChatBot! Ask about Akshay Kumar or Artificial Intelligence.")
...
if __name__ == "__main__":
    json_files = ["Vijay.json", "LanaDelRey2.json"]
